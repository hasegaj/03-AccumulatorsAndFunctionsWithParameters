...
#                attatch_to, clone, detatch_from
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                center, fill_color, outline_thickness
#
#     f. What does a RoseWindow RENDER method do?
#            updates all shapes attatched to canvas
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            at the end of the code, so that you can close the window after the function has run
#
